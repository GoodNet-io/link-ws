# Standalone dev / test / build flake for the goodnet-link-ws
...
#
# goodnet-standalone-plugin: ws
{
  description = "GoodNet link plugin: ws — standalone plugin flake.";
    ...
    in
    {
      ...
      devShells = forAllSystems (system: pkgs: {
        default = helpers.mkPluginDevShell pkgs {
          ...
          welcomeText = ''
  goodnet-link-ws  —  standalone plugin dev shell
    ...
    nix run .#debug      — Debug build + gdb on test_ws
'';
        };
      });
